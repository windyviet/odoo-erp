...
git clone --depth=1 git@github.com:windyviet/odoo-erp.git $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: B@nhieusuat2025 | Live chat port: $CHAT"
