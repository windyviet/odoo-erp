...
to set up first Odoo instance @ `localhost:10012` (default master password: `B@nhieusuat2025`)
...
to set up another Odoo instance @ `localhost:11012` (default master password: `B@nhieusuat2025`)
...
* Default database password (**admin_passwd**) is `B@nhieusuat2025`, please change it @ [etc/odoo.conf#L55](/etc/odoo.conf#L55)
